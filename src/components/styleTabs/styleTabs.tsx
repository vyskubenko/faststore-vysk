...
const styleTabs: FC<styleTabsProps> = ({ tabs }): ReactElement => {
    ...
    <section className={styles.styleTabs} data-fs-content>
      ...
      <div className={`${styles.styleTabs__container} tab__container`}>
        <div className={`${styles.styleTabs__col} ${styles.styleTabs__banner}`}>
          <div
            className={styles.styleTabs__banner__img}
            key={tabs[activeTab].banner.title}
            data-fs-hero-image
          >
            ...
            <div className={styles.carouselBanners__content}>
              <h3 className={styles.carouselBanners__title}>
                {tabs[activeTab].banner.title}
              </h3>
              <Button
                className={styles.carouselBanners__button}
                variant="primary"
              >
                {tabs[activeTab].banner.linkText}
              </Button>
            </div>
          </div>
        </div>
        <div
          className={`${styles.styleTabs__col} ${styles.styleTabs__gallery} tab__content`}
        >
          {loading ? (
            <Skeleton
